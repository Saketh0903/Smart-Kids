      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <div className={'mb-4'}>
            ...
            {rewards.description ? (
              <p dangerouslySetInnerHTML={{ __html: rewards.description }} />
            ) : (
              <p>No data</p>
            )}
          </div>
            ...
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {rewards.eligible_users &&
                      Array.isArray(rewards.eligible_users) &&
                      rewards.eligible_users.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
