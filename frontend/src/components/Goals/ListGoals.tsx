...
const ListGoals = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_GOALS');
              ...
              >
                ...
                >
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>GoalName</p>
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/goals/goals-edit/?id=${item.id}`}
                  pathView={`/goals/goals-view/?id=${item.id}`}
