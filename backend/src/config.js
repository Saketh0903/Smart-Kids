...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '7c5593f128853ae10e47c92baba4e09c',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'affects their school performance and social growth <app@flatlogic.app>',
  ...
  project_uuid: 'bda4a355-f971-4fc2-a11c-fff7a0ca9ebd',
  flHost:
...
config.pexelsQuery = 'children learning with AI';
config.host =
