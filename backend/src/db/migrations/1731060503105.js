module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('rewards', 'points', { transaction });

      await queryInterface.removeColumn('rewards', 'description', {
        transaction,
      });

      await queryInterface.removeColumn('rewards', 'title', { transaction });

      await queryInterface.removeColumn('goals', 'userId', { transaction });
      ...
      await queryInterface.removeColumn('activities', 'name', { transaction });
